...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([[
            ...
            'avatar' => 'http://localhost:8000/avatar/1672584134_Farhan_avatar.jpg',
        ...
        [
            ...
            'verifikasi' => true,
            'token_verifikasi' => Str::random(128),
            'avatar' => 'http://localhost:8000/avatar/1672583339_Kurnia_avatar.jpg',
        ...
        [
            ...
            'verifikasi' => true,
            'token_verifikasi' => Str::random(128),
            'avatar' => 'http://localhost:8000/avatar/1672584926_Afif_avatar.jpg',
        ...
        [
            ...
            'avatar' => 'http://localhost:8000/avatar/1672584507_Alfiano_avatar.jpg',
